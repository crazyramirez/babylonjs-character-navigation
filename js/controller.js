...
function setJoystickController() {
    ...
    scene.registerBeforeRender(()=>{
        ...
        if (leftJoystick.pressed && leftJoystick.deltaPosition.y != 0) {
            ...
            // frontVector = player.getDirection(new BABYLON.Vector3(0,jumpValue,1)).scale(leftJoystick.deltaPosition.y*joystickSpeedMovement*dt);
